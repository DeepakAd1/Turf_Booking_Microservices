package com.example.turf_service.controller;
import com.example.turf_service.service.TurfService;
...
public class TurfController {
    ...
    public ResponseEntity<TurfDetails> getTurfById(@PathVariable("id") long id){
